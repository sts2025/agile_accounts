    ...
    <div class="receipt-wrapper">
        ...
        <div class="financials">
            <div class="info-row">
                ...
                <span class="value"><?php echo e($currency); ?> <?php echo e(number_format($payment->principal_paid ?? 0, 0)); ?></span>
            </div>
            
            <div class="info-row">
                <span class="label">Interest Paid:</span>
                <span class="value"><?php echo e($currency); ?> <?php echo e(number_format($payment->interest_paid ?? 0, 0)); ?></span>
            </div>
