                ...
                <tbody>
                    @foreach ($schedule as $payment_schedule)
                        <tr>
                            ...
                            <td>{{ \Carbon\Carbon::parse($payment_schedule['due_date'])->format('F d, Y') }}</td>
                            <td>{{ number_format($payment_schedule['payment_amount'], 2) }}</td>
                            <td>{{ number_format($payment_schedule['principal'], 2) }}</td>
                            <td>{{ number_format($payment_schedule['interest'], 2) }}</td>
                            <td>{{ number_format($payment_schedule['balance'], 2) }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
...
@push('modals')
    {{-- Your modals for Payment, Guarantor, and Collateral --}}
    <div class="modal fade" id="paymentModal" ...> ... </div>
    <div class="modal fade" id="guarantorModal" ...> ... </div>
    <div class="modal fade" id="collateralModal" ...> ... </div>
@endpush