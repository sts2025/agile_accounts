                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $loans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $loan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo e(route('clients.edit', $loan->client->id)); ?>" class="font-weight-bold text-dark" style="text-decoration: underline;">
                        ...
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <tr>
                                <td colspan="8" class="text-center py-4">No loans found. <a href="<?php echo e(route('loans.create')); ?>">Create one now</a>.</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
