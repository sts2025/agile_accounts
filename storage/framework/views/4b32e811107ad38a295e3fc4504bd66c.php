...
<?php $__env->startSection('title', 'Savings Accounts'); ?>
...
<div class="container-fluid px-0">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="<?php echo e(route('mfi.savings.create')); ?>" class="btn btn-success fw-bold shadow-sm">
                ...
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-muted small"><?php echo e($account->client->phone_number ?? 'N/A'); ?></td>
                            <td class="text-end text-success fw-bold font-monospace bg-light fs-5">
                                <?php echo e(number_format($account->balance)); ?>
    ...
    <a href="<?php echo e(route('mfi.savings.show', $account->id)); ?>" class="btn btn-sm btn-outline-primary shadow-sm">
        <i class="fas fa-exchange-alt"></i> Transact
                        ...
                        <tr>
                            <td colspan="6" class="text-center py-5 text-muted">
                                ...
                                <a href="<?php echo e(route('mfi.savings.create')); ?>" class="btn btn-sm btn-outline-primary mt-2">Open First Account</a>
                            </td>
                        </tr>
                        <?php endif; ?>
                    </tbody>
...
<?php echo $__env->make('layouts.manager', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\agile_accounts\agile_accounts\resources\views/loan-manager/mfi/savings/index.blade.php ENDPATH**/ ?>