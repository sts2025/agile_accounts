        ...
        <div class="login-body">
            ...
            <form method="POST" action="<?php echo e(route('login')); ?>">
                ...
                <div class="mb-3">
                    ...
                    <input type="email" class="form-control" name="email" placeholder="name@example.com" value="<?php echo e(old('email')); ?>" required autofocus>
                </div>
                <div class="mb-4">
                    <div class="d-flex justify-content-between">
                        <label class="form-label small fw-bold text-muted">Password</label>
                        <a href="<?php echo e(route('password.request')); ?>" class="small text-decoration-none">Forgot?</a>
                    </div>
            ...
            <div class="text-center">
                ...
                <p class="mb-0 small">
                    New here? <a href="<?php echo e(route('register')); ?>" class="fw-bold text-decoration-none">Create a Manager Account</a>
                </p>
            </div>
        </div>
    </div>
