<?php $__env->startSection('title', 'Open Fixed Deposit'); ?>
...
<div class="container-fluid px-0">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="<?php echo e(route('mfi.fixed-deposits.index')); ?>" class="btn btn-secondary shadow-sm">
    ...
    <?php if($products->isEmpty()): ?>
        <div class="alert alert-warning shadow-sm border-start border-warning border-4">
            ...
            <a href="<?php echo e(route('mfi.products.create', ['type' => 'fixed_deposit'])); ?>" class="fw-bold">Create one now</a>.
        </div>
    <?php else: ?>
    <div class="card shadow-sm border-0" style="max-width: 700px;">
        ...
        <div class="card-body p-4 bg-light">
            ...
            <form action="<?php echo e(route('mfi.fixed-deposits.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                    ...
                    <select name="mfi_product_id" class="form-select shadow-sm" required>
                        <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($product->id); ?>">
                                <?php echo e($product->name); ?> — <?php echo e(number_format($product->interest_rate, 2)); ?>% over <?php echo e($product->term_months); ?> months
                            </option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="number" step="0.01" min="1000" name="principal_amount" class="form-control shadow-sm" required value="<?php echo e(old('principal_amount')); ?>">
                </div>

                <div class="mb-4">
                    <label class="form-label fw-bold text-dark">Start Date</label>
                    <input type="date" name="start_date" class="form-control shadow-sm" required value="<?php echo e(old('start_date', date('Y-m-d'))); ?>">
                </div>
                ...
                <div class="d-flex gap-2 pt-2 border-top">
                    ...
                    <a href="<?php echo e(route('mfi.fixed-deposits.index')); ?>" class="btn btn-light fw-bold py-2">Cancel</a>
                </div>
            </form>
        </div>
    </div>
...
<?php echo $__env->make('layouts.manager', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\agile_accounts\agile_accounts\resources\views/loan-manager/mfi/fixed-deposits/create.blade.php ENDPATH**/ ?>