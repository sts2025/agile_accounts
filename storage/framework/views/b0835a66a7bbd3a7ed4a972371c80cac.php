...
<body>
    <div class="sidebar">
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#clients-submenu" data-bs-toggle="collapse" aria-expanded="<?php echo e(request()->routeIs('clients.*') ? 'true' : 'false'); ?>"> 
                ...
                <div class="collapse <?php echo e(request()->routeIs('clients.*') ? 'show' : ''); ?>" id="clients-submenu">
                    <ul class="nav flex-column ms-2">
                        ...
                        <li class="nav-item"><a class="nav-link <?php echo e(request()->routeIs('clients.index') && !request()->has('filter') ? 'active' : ''); ?>" href="<?php echo e(route('clients.index')); ?>">All Clients</a></li>
            ...
            <li class="nav-item"> 
                <a class="nav-link collapsed" href="#loans-submenu" data-bs-toggle="collapse" aria-expanded="<?php echo e(request()->routeIs('loans.*') ? 'true' : 'false'); ?>"> 
                ...
                <div class="collapse <?php echo e(request()->routeIs('loans.*') ? 'show' : ''); ?>" id="loans-submenu">
                    <ul class="nav flex-column ms-2">
                        ...
                        <li class="nav-item"><a class="nav-link <?php echo e(request()->routeIs('loans.create') ? 'active' : ''); ?>" href="<?php echo e(route('loans.create')); ?>">Create New Loan</a></li>
                        
                        
                        <li class="nav-item"><a class="nav-link <?php echo e(request()->input('filter') == 'completed' ? 'active' : ''); ?>" href="<?php echo e(route('loans.index', ['filter' => 'completed'])); ?>">Completed Loans</a></li>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#reports-submenu" data-bs-toggle="collapse" aria-expanded="<?php echo e(request()->routeIs('reports.*') ? 'true' : 'false'); ?>"> 
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#transactions-submenu" data-bs-toggle="collapse" aria-expanded="<?php echo e(request()->routeIs(['bank-transactions.*', 'expenses.*', 'cash-transactions.*']) ? 'true' : 'false'); ?>"> 
