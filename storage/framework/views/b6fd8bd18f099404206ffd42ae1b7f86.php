...
<body>
    <div class="container mt-5">
        ...
        <div class="card">
            <div class="card-body">
                <form method="POST" action="<?php echo e(route('admin.broadcasts.store')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="mb-3">
...
</html><?php /**PATH C:\xampp\htdocs\agile_accounts\agile_accounts\resources\views/admin/broadcasts/index.blade.php ENDPATH**/ ?>