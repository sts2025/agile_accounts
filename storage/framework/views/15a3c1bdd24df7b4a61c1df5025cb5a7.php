                                    ...
                                    <table class="table table-bordered table-hover align-middle">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end text-primary font-monospace"><?php echo e(number_format($payment->principal_paid)); ?></td>
                                                <td class="text-end text-warning font-monospace"><?php echo e(number_format($payment->interest_paid)); ?></td>
                                                <td class="text-end text-success fw-bold bg-light font-monospace"><?php echo e(number_format($payment->amount_paid)); ?></td>
