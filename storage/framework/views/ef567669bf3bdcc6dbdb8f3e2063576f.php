                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td>
                                    <div class="fw-bold text-dark"><?php echo e($payment->loan->client->name ?? 'Unknown'); ?></div>
                                    <div class="small text-muted">Ref: <?php echo e($payment->receipt_number ?? 'N/A'); ?></div>
                                </td>
                                <td class="text-end text-primary font-monospace">
                                    <?php echo e(number_format($payment->principal_paid, 0)); ?>

                                </td>
                                <td class="text-end text-warning font-monospace">
                                    <?php echo e(number_format($payment->interest_paid, 0)); ?>

                                </td>
                                <td class="text-end fw-bold font-monospace text-dark bg-light">
                                    <?php echo e(number_format($payment->amount_paid, 0)); ?>

                                </td>
                                <td>
                                    <span class="badge bg-light text-dark border"><?php echo e(ucfirst($payment->payment_method)); ?></span>
                                </td>
                                <td class="text-center no-print">
                                    <a href="<?php echo e(route('payments.receipt', $payment->id)); ?>" class="btn btn-sm btn-outline-secondary" title="Print Receipt">
                        ...
                        <select name="loan_id" class="form-select shadow-sm" required>
                            ...
                            <?php $__currentLoopData = $loans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $loan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($loan->id); ?>">
                                    ...
                                    (Bal: <?php echo e(number_format($loan->principal_amount + ($loan->principal_amount * ($loan->interest_rate/100)) - $loan->payments->sum('amount_paid'))); ?>)
                                </option>
...
<?php echo $__env->make('layouts.manager', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\agile_accounts\agile_accounts\resources\views/loan-manager/payments/index.blade.php ENDPATH**/ ?>