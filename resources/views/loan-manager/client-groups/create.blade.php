...
@section('title', 'New Client Group')
...
<div class="container-fluid px-0">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0 text-dark fw-bold">New Client Group</h1>
        <a href="{{ route('client-groups.index') }}" class="btn btn-secondary shadow-sm">
        ...
        <div class="card-body p-4 bg-light">
            ...
            <form action="{{ route('client-groups.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="name" class="form-control shadow-sm" value="{{ old('name') }}" required placeholder="e.g. Kampala Traders Circle">
                </div>

                <div class="mb-3">
                    <label class="form-label fw-bold text-dark">Description <span class="text-secondary fw-normal">(Optional)</span></label>
                    <textarea name="description" class="form-control shadow-sm" rows="2">{{ old('description') }}</textarea>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <small class="text-muted d-block mt-1">You can add or remove members later from the group page.</small>
                </div>
                ...
                <div class="d-flex gap-2 pt-2 border-top">
                    ...
                    <a href="{{ route('client-groups.index') }}" class="btn btn-light fw-bold py-2">Cancel</a>
                </div>
            </form>
        </div>
    </div>
