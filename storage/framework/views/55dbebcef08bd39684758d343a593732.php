        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo e(route('dashboard')); ?>">
                <div class="sidebar-brand-icon">
                    ...
                    <img src="<?php echo e(asset('img/logo.png')); ?>" alt="Agile Accounts Logo" style="height: 40px;" onerror="this.style.display='none'">
                    <i class="fas fa-landmark" style="display:none;" onerror="this.style.display='block'"></i> 
                </div>
            ...
            <li class="nav-item <?php echo e(request()->routeIs('clients.*') ? 'active' : ''); ?>">
                ...
                <div id="collapseClients" class="collapse <?php echo e(request()->routeIs('clients.*') ? 'show' : ''); ?>"
                    aria-labelledby="headingClients" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Actions:</h6>
                        <a class="collapse-item <?php echo e(request()->routeIs('clients.index') && !request()->has('filter') ? 'active' : ''); ?>" href="<?php echo e(route('clients.index')); ?>">All Clients</a>
                        <a class="collapse-item <?php echo e(request()->routeIs('clients.create') ? 'active' : ''); ?>" href="<?php echo e(route('clients.create')); ?>">Add New Client</a>
                        
                        <h6 class="collapse-header">Filters:</h6>
                        <a class="collapse-item <?php echo e(request()->input('filter') == 'not_paid' ? 'active' : ''); ?>" href="<?php echo e(route('clients.index', ['filter' => 'not_paid'])); ?>">Not Paid</a>
                        <a class="collapse-item <?php echo e(request()->input('filter') == 'with_loans' ? 'active' : ''); ?>" href="<?php echo e(route('clients.index', ['filter' => 'with_loans'])); ?>">With Loans</a>
                        <a class="collapse-item <?php echo e(request()->input('filter') == 'no_loans' ? 'active' : ''); ?>" href="<?php echo e(route('clients.index', ['filter' => 'no_loans'])); ?>">Without Loans</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item <?php echo e(request()->routeIs('loans.*') ? 'active' : ''); ?>">
                ...
                <div id="collapseLoans" class="collapse <?php echo e(request()->routeIs('loans.*') ? 'show' : ''); ?>"
                    aria-labelledby="headingLoans" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Actions:</h6>
                        <a class="collapse-item <?php echo e(request()->routeIs('loans.index') && !request()->has('filter') ? 'active' : ''); ?>" href="<?php echo e(route('loans.index')); ?>">All Loans</a>
                        <a class="collapse-item <?php echo e(request()->routeIs('loans.create') ? 'active' : ''); ?>" href="<?php echo e(route('loans.create')); ?>">Create New Loan</a>
                        
                        
                        <a class="collapse-item <?php echo e(request()->input('filter') == 'completed' ? 'active' : ''); ?>" href="<?php echo e(route('loans.index', ['filter' => 'completed'])); ?>">Completed Loans</a>
                        
                        <div class="collapse-divider"></div>
                        <h6 class="collapse-header">Tools:</h6>
                        <a class="collapse-item <?php echo e(request()->routeIs('loans.showCalculator') ? 'active' : ''); ?>" href="<?php echo e(route('loans.showCalculator')); ?>">Loan Calculator</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item <?php echo e(request()->is('reports*') ? 'active' : ''); ?>">
                ...
                <div id="collapseReports" class="collapse <?php echo e(request()->is('reports*') ? 'show' : ''); ?>"
            ...
            <li class="nav-item <?php echo e(request()->is('*-transactions*') || request()->is('expenses*') ? 'active' : ''); ?>">
                ...
                <div id="collapseTransactions" class="collapse <?php echo e(request()->is('*-transactions*') || request()->is('expenses*') ? 'show' : ''); ?>"
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo e(Auth::user()->name ?? 'User'); ?></span>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>
                            Developed by <strong>BKR TECH</strong> &copy; <?php echo e(date('Y')); ?> | Need help? 
